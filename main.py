...
class PongGame(Widget):
    ...
    def update(self, dt):
        ...
        if (self.ball.x < self.x) and (self.player2.score != 5) and (self.player1.score != 5):
            self.player2.score += 1
            self.serve_ball()

        if (self.ball.right > self.width) and (self.player1.score != 5) and (self.player2.score != 5):
